...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('set-botlogs-channel')
        .setDescription('Sets the channel for the bot logs.')
        .addChannelOption(option =>
            option.setName('channel')
                .setDescription('The channel to set as the bot logging channel.')
                .setRequired(true)
        )
    ...
    async execute(interaction) {
        ...
        try {
            ...
            guildConfig.botLogsChannelId = channel.id;
